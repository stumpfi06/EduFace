<template>
  <div v-if="userRole" :class="['sidebar', { collapsed: isCollapsed }]">
    ...
    <a
      ...
      href="#lehrer"
      :class="{ active: currentHash === 'lehrer' }"
    >
    ...
    <a
      v-if="userRole === 'admin' || userRole === 'lehrer'"
      href="#schueler"
      :class="{ active: currentHash === 'schueler' }"
    >
    ...
    <a
      v-if="userRole === 'admin' || userRole === 'lehrer'"
      href="#klassen"
      :class="{ active: currentHash === 'klassen' }"
    >
    ...
    <a
      v-if="userRole === 'admin'"
      href="#userverwaltung"
      :class="{ active: currentHash === 'userverwaltung' }"
    >
...
<style src="@/css/Interface/Sidebar.css" scoped></style>
