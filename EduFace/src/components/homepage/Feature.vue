...
const features = [
    {
        ...
        description: "Anpassbar an jede Schüleranzahl und individuell konfigurierbar für die Anforderungen jeder Schule."
    },{
